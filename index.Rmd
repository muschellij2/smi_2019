...
- Depends: package3, package5
  - packages with **ALL** functions loaded from package, but **loaded in user library** before your package
...
# You do not have `library()` functions\n in R package code
